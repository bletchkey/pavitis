...
<section>
	...
	<h1 class="title_doc">Scegli la classe con cui vuoi condividere il documento</h1>
	...
	while($row = mysqli_fetch_assoc($result)){
			...
			<div class='form-classi'>
					...
					<td class='td-classi'><a href='documenti2_doc.php?class_id=".$classe_id."'><div class='text-classi'>".$classe_n."&nbsp".$classe_s."</div></a></td>
