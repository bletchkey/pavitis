...
<section>
	...
	$_SESSION['$id_classe_mat'] = $idclass;
	...
	while($row = mysqli_fetch_assoc($result_1)){
			...
			echo "
			  <tr>
				...
				<td class='td-ins-edit' style='padding-left:10px;padding-right:10px;'><a href='ins_voto_individuale_3.php?studid=".$id_stud."'><img class='edit-pencil' src='../img/registro_img/aggiungi_acc.png'></a></td>
			  </tr>
			";
