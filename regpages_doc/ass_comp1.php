...
<section>
	...
	<h1 class="title_doc">Scegli la classe a cui vuoi assegnare un compito</h1>
	...
	while($row = mysqli_fetch_assoc($result)){
			...
			<div class='form-classi'>
					...
					<td class='td-classi'><a href='ass_comp2.php?class_id=".$classe_id."'><div class='text-classi'>".$classe_n."&nbsp".$classe_s."</div></a></td>
