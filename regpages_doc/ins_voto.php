...
<section>
	...
	<h1 class="title_doc">Scegli in che classe vuoi inserire i voti:</h1>
	...
	while($row = mysqli_fetch_assoc($result)){
			...
			<div class='form-classi'>
					...
					<td class='td-classi'><a href='ins_voto2.php?class_id=".$classe_id."'><div class='text-classi'>".$classe_n."&nbsp".$classe_s."</div></a></td>
