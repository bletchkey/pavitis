...
<section>
	...
	<h1 class="title_doc">Scegli l'amministratore a cui vuoi modificare i dati</h1>
	...
	while($row = mysqli_fetch_assoc($result_1)){
			...
			echo "
			  ...
			  <tr>
				...
				<td class='td-ins-edit' style='padding-left:10px;padding-right:10px;'><a href='edit-acc-adm2.php?admid=".$id_adm."'><img class='edit-pencil' src='../img/registro_img/aggiungi_acc.png'></a></td>
