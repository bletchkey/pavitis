...
<section>
	...
	<h1 class="title_doc">Scegli lo studente a cui vuoi modificare/caricare la foto di profilo</h1>
	...
	while($row = mysqli_fetch_assoc($result_1)){
			...
			echo "
			  ...
			  <tr>
				...
				<td class='td-ins-edit' style='padding-left:10px;padding-right:10px;'><a href='ins-pic-stud2.php?studid=".$id_stud."'><img class='edit-pencil' src='../img/registro_img/aggiungi_acc.png'></a></td>
