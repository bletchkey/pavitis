<?php
	...
	$username = htmlspecialchars($_POST['username_a'],ENT_QUOTES);
	...
	$result = mysqli_query($dbconn, "SELECT * FROM accountAdm WHERE username = '" . mysqli_real_escape_string($dbconn, $username) . "'");
