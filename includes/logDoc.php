<?php
	...
	$username = htmlspecialchars($_POST['username_d'],ENT_QUOTES);

	$password = md5($_POST['password_d']);
	...
	$result = mysqli_query($dbconn, "SELECT * FROM accountDoc WHERE username = '" . mysqli_real_escape_string($dbconn, $username) . "'");
